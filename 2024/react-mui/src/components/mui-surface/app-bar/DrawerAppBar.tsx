// components/mui-surface/app-bar/DrawerAppBar.tsx
...
function MenuButtonXsSm({ handleClick }: { handleClick(): void }) {
  return (
    <IconButton
      color="inherit"
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar component="nav">
        <Toolbar>
          <MenuButtonXsSm handleClick={handleDrawerToggle} />
          <NavMenuSm />
        </Toolbar>
      </AppBar>
      <NavDrawerXsSm open={mobileOpen} handleClick={handleDrawerToggle} />
      <Main />
    </Box>
  );
}
