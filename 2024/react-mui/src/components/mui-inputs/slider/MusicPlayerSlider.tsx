// components/mui-inputs/slider/MusicPlayerSlider.tsx
      ...
      <Widget>
        ...
        >
          <IconButton aria-label="previous song">
            <FastRewindRoundedIcon fontSize="large" htmlColor={mainIconColor} />
          </IconButton>
          <IconButton
        ...
        <Stack
          ...
          alignItems="center"
        >
          <VolumeDownRoundedIcon htmlColor={lightIconColor} />
          <Slider
            aria-label="Volume"
            defaultValue={30}
            sx={{
          ...
          />
          <VolumeUpRoundedIcon htmlColor={lightIconColor} />
        </Stack>
      </Widget>
      <WallPaper />
    </Box>
