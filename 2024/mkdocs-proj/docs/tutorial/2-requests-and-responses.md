...
Go ahead and test the API from the command line, as we did in [tutorial part 1](https://www.django-rest-framework.org/tutorial/1-serialization/). Everything is working pretty similarly, although we've got some nicer error handling if we send invalid requests.
...
In [tutorial part 3](https://www.django-rest-framework.org/tutorial/3-class-based-views/), we'll start using class-based views, and see how generic views reduce the amount of code we need to write.
